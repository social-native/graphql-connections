...
import { IAttributeMap, IQueryBuilder, IQueryBuilderOptions } from './types';
export default class KnexQueryBuilder implements IQueryBuilder<Knex> {
    private queryContext;
    private attributeMap;
    private filterMap;
    constructor(queryContext: QueryContext, attributeMap: IAttributeMap, options?: IQueryBuilderOptions);
